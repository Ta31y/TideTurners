...
AFRAME.registerComponent("game-manager", {
  init: function () {
    ...
    // while dialog is open, block scene clicks
    this.setCanvasInteractive(false);
  },

  // make scene canvas clickable / not clickable
  ...
  startTransition: function () {
    ...
    this.setCanvasInteractive(true); // back to scene
  ...
  startLevel: function (idx) {
    ...
    // restore "Next" button (we hide it at the very end)
  ...
  endLevel: function () {
    ...
    // block scene clicks while board is open
    this.setCanvasInteractive(false);
  ...
  finish: function () {
    ...
    // block scene clicks during final board
    this.setCanvasInteractive(false);
  ...
  turtleThankYou: function (total) {
    ...
    function showDialog() {
      ...
      // block scene clicks while dialog is on
